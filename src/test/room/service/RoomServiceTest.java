...
public class RoomServiceTest {
    ...
    public void testUpdateRoom_InvalidData_Name() {
        ...
        mockRoom.setHouse(new House());
        //when
        lenient().when(houseRepository.findById(1L)).thenReturn(java.util.Optional.of(house));
    ...
    @Test
    public void getRoom_1() throws BadRequestException {
        // Given
        Room mockRoom = new Room();
        mockRoom.setId(1L);
        mockRoom.setName("Test Room");
    ...
    @Test
    public void getRoom_2() throws BadRequestException {
        // Given
        Room mockRoom = new Room();
        mockRoom.setId(1L);
        mockRoom.setName("Test Room 2");
    ...
    @Test
    public void getRoom_3() throws BadRequestException {
        // Given
        Room mockRoom = new Room();
        mockRoom.setId(1L);
