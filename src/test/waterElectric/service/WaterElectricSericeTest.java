...
public class WaterElectricSericeTest {
    ...
    public void updateWaterElectric() {
        ...
        newWaterElectric.setRoom(room);

        // Mock the dependencies
        lenient().when(roomRepository.findById(room.getId())).thenReturn(Optional.of(room));
        lenient().when(waterElectricRepository.findByRoom_Id(room.getId())).thenReturn(new WaterElectric());
        lenient().when(waterElectricRepository.save(any(WaterElectric.class))).thenReturn(newWaterElectric);
        ...
        assertEquals(newWaterElectric.getRoom(), updatedWaterElectric.getRoom());
    }
